...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Blue[/B][/COLOR]Wizard'
BUILDERNAME = 'KRMBuild'
EXCLUDES = [ADDON_ID, 'repository.BlueKodirepo']
# Text File with build info in it.
BUILDFILE = 'https://www.dropbox.com/s/tlobr16qkwpzsri/wizard.txt?dl=1'
...
#           ICONSETTINGS  = 'https://www.dropbox.com/s/nubjx32lkjhkbmh/icon.png?dl=1'
...
REPOID = 'repository.BlueKodirepo'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Blue[/B][/COLOR]Wizard'
# url to image if using Image 424x180
HEADERIMAGE = 'http://'
# Font for Notification Window
FONTSETTINGS = 'Font13'
# Background for Notification Window
BACKGROUND = 'https://www.dropbox.com/s/eztnzjjpftlkiy6/fanart.jpg?dl=1'
#########################################################
